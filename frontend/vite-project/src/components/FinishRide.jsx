...
const FinishRide = (props) => {
  return (
    <div className='p-4'>
      <h5 onClick={()=>props.setFinishRide(false)} className='w-[93%] p-1 absolute top-0 text-center ' ><i className="text-3xl text-gray-300 ri-arrow-down-wide-line"></i></h5>   
    <h3 className="text-2xl mt-4 font-semibold mb-5">Finsih this Ride  </h3>
     ...
     <div className='w-full'>
               ...
               <Link to={'/captainhome'}>
                   <button
                     ...
                     className='w-full p-3 text-lg  bg-green-600 font-semibold text-white rounded-lg'
                     >
                       Complete this Ride
                     </button>
               </Link>
